...
1. Install the [desktop client](https://github.com/Khoality-dev/KurisuAssistant/releases/latest) or [Android client](https://github.com/Khoality-dev/KurisuAssistant/releases/latest).
