/**
 * The capabilities a host can lend the renderer, as types.
 *
 * These were the desktop app's `src/types/electron.d.ts`, where they described
...
export interface ElectronAPI {
  platform: string;
  /** `app.getVersion()` — the number the updater compares against `latest.yml` (#257). */
  appVersion: string;
