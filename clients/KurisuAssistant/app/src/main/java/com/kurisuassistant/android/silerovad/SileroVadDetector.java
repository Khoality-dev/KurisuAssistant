...
public class SileroVadDetector {
    ...
    /**
     * Constructor
     * @param modelBuffer the path of silero-vad onnx model
     ...
     * @throws OrtException
     */
    public SileroVadDetector(ByteBuffer modelBuffer, float threshold, int samplingRate,
        ...
        this.model = new SileroVadOnnxModel(modelBuffer);
