...
export const TOOL_GROUP_MAP: Record<string, string> = {
  ...
  host_list: 'Host',
  host_bash: 'Host',
  app_get_assistant: 'App',
  app_update_assistant: 'App',
  app_get_personas: 'App',
  app_create_persona: 'App',
  app_update_persona: 'App',
  app_delete_persona: 'App',
  app_get_sub_agents: 'App',
  app_create_sub_agent: 'App',
  app_update_sub_agent: 'App',
  app_delete_sub_agent: 'App',
