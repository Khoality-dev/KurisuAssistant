...
class TTS_Config:
    ...
    def __init__(self, configs: Union[dict, str] = None):
        # 设置默认配置文件路径
        # PATCHED (voice/vendor/gpt_sovits/PATCHES.md): the configs directory is
        # the vendored tree's own, not one under the working directory. It is
        # still written to — init_vits_weights saves the chosen weights there.
        configs_base_path: str = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "configs")
