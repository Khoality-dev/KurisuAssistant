...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(
        # PATCHED (voice/vendor/gpt_sovits/PATCHES.md): a directory under the data
        # volume rather than one relative to the working directory.
        model_dir=os.environ.get("g2pw_model_dir", os.path.join(current_file_path, "G2PWModel")),
