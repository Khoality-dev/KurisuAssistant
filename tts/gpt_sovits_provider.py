...
class GPTSoVITSProvider(BaseTTSProvider):
    ...
    def _find_voice_file(self, voice_name: str) -> str:
        ...
        Returns:
            Full path relative to working directory with Linux-style separators
            (e.g., "reference/ayaka_ref.wav")
        ...
        for ext in audio_extensions:
            ...
            if voice_path.exists():
                # Convert to Linux-style path for Docker container
                # Use as_posix() to ensure forward slashes
                return voice_path.as_posix()
    ...
    def synthesize(
        ...
        **kwargs
        ...
        Args:
            ...
            voice: Voice name without extension (e.g., "ayaka_ref") - must match a voice from /tts/voices
            language: Language code (defaults to "ja")
        ...
        for i, chunk in enumerate(text_chunks):
            ...
            try:
                ...
                logger.error(f"GPT-SoVITS API request failed for chunk {i+1}: {e}", exc_info=True)
    ...
    def list_voices(self) -> list[str]:
        ...
        Note: GPT-SoVITS uses reference audio files.
